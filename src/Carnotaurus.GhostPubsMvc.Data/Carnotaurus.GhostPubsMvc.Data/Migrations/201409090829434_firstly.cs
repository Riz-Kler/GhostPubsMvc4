    ...
    public partial class firstly : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        TradingStatus = c.Int(),
                        HauntedStatus = c.Int(),
                        TradingName = c.String(nullable: false, maxLength: 300),
            ...
            CreateTable(
                ...
                .ForeignKey("Organisation.Org", t => t.OrgID, cascadeDelete: true)
                .Index(t => t.OrgID);
            ...
            CreateTable(
                ...
                .ForeignKey("Organisation.Feature", t => t.FeatureID, cascadeDelete: true)
                .ForeignKey("Organisation.Org", t => t.OrgID)
                .Index(t => t.OrgID)
                .Index(t => t.FeatureID);
            ...
            CreateTable(
                ...
                .ForeignKey("Category.FeatureType", t => t.FeatureTypeID, cascadeDelete: true)
