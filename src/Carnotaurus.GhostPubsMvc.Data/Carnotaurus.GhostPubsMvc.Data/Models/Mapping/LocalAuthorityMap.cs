...
namespace Carnotaurus.GhostPubsMvc.Data.Models.Mapping
{
    public class LocalAuthorityMap : EntityTypeConfiguration<LocalAuthority>
    {
        public LocalAuthorityMap()
        {
            ...
            // Properties
            this.Property(t => t.Local_Authority)
                .HasMaxLength(255);
            ...
            this.Property(t => t.Local_Authority).HasColumnName("Local Authority");
            this.Property(t => t.Region).HasColumnName("Region");
            this.Property(t => t.Number_of_breweries).HasColumnName("Number of breweries");
            this.Property(t => t.Number_of_pubs).HasColumnName("Number of pubs");
            ...
            this.Property(t => t.Direct_employment_by_age).HasColumnName("Direct employment by age");
            ...
            this.Property(t => t.Direct_employment_by_status).HasColumnName("Direct employment by status");
            this.Property(t => t.F26).HasColumnName("F26");
            this.Property(t => t.F27).HasColumnName("F27");
            this.Property(t => t.Net_capital_expenditure___m_).HasColumnName("Net capital expenditure (£m)");
            this.Property(t => t.F29).HasColumnName("F29");
            this.Property(t => t.Total_tax_estimates___m_).HasColumnName("Total tax estimates (£m)");
            ...
            this.Property(t => t.Direct_tax_estimates___m_).HasColumnName("Direct tax estimates (£m)");
