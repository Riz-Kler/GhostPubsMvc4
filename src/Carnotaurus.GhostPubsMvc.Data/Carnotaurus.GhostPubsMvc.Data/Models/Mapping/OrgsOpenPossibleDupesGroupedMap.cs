...
{
    public class OrgsOpenPossibleDupesGroupedMap : EntityTypeConfiguration<OrgsOpenPossibleDupesGrouped>
    {
        public OrgsOpenPossibleDupesGroupedMap()
        {
            // Primary Key
            this.HasKey(t => new {t.OrgID, t.Created, t.Modified, t.TradingName});
            ...
            this.ToTable("OrgsOpenPossibleDupesGrouped");
